...
import vue3AsyncComponent from "./vue3/AsyncDataComponent.vue?raw";

// React
import reactComponent from "./react/Component.jsx?raw";
import reactAsyncComponent from "./react/AsyncDataComponent.jsx?raw";
import reactCss from "./react/Component.module.css?raw";
...
export const suspense = {
  ...
  vue3: {
    files: [
      { name: "Component.vue", content: vue3Component },
      { name: "AsyncDataComponent.vue", content: vue3AsyncComponent },
    ],
  },
  react: {
    files: [
      { name: "Component.jsx", content: reactComponent },
      { name: "AsyncDataComponent.jsx", content: reactAsyncComponent },
      { name: "Component.module.css", content: reactCss },
    ],
  },
  svelte4: {
