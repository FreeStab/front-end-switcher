...
import reactStyles from "./react/Component.module.css?raw";
...
import solidStyles from "./solid/Component.css?raw";
...
export const styling = {
  ...
  react: {
    files: [
      ...
      { name: "Component.module.css", content: reactStyles },
    ],
  },
  svelte4: {
  ...
  solid: {
    files: [
      { name: "Component.jsx", content: solidComponent },
      { name: "Component.css", content: solidStyles },
    ],
  },
  alpine: {
